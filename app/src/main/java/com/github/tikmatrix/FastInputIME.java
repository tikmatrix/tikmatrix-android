...
public class FastInputIME extends InputMethodService {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                case "ADB_INPUT_TEXT":
                     ...
                     * adb shell am broadcast -a ADB_INPUT_TEXT --es text
    ...
    private void clearText() {
        // Refs:
        // https://stackoverflow.com/questions/33082004/android-custom-soft-keyboard-how-to-clear-edit-text-commited-text
        InputConnection ic = getCurrentInputConnection();
        if (ic == null) {
            return;
        }
