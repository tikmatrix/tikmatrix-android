...
package com.github.tikmatrix.compat;

import android.view.InputEvent;
import android.view.KeyEvent;

import com.github.tikmatrix.util.InternalApi;
...
public class InputManagerWrapper {
    ...
    // catch (NoSuchMethodException e) {
    // e.printStackTrace();
    // throw new UnsupportedOperationException("WindowManagerEventInjector is not
    // supported");
    // }
    // }
    //
